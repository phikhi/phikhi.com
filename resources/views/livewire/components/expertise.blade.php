    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
                ...
                <h3 class="text-xl font-semibold mb-3">Leadership & Coaching</h3>
                <p class="text-neutral-700 dark:text-neutral-300 mb-4">
                    Accompagnement des équipes et des individus pour développer leur potentiel et atteindre leurs objectifs.
                </p>
                <ul class="space-y-2">
                    <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-purple-600 dark:text-purple-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
