        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div class="lg:w-1/2">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    Senior Product Manager <span class="text-blue-600 dark:text-blue-400">Freelance</span>
                </h1>
            ...
            <div class="lg:w-1/2">
                <div class="relative">
                    <div class="absolute -top-6 -left-6 w-24 h-24 bg-blue-200 dark:bg-blue-900 rounded-full opacity-70 blur-xl"></div>
                    <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-indigo-200 dark:bg-indigo-900 rounded-full opacity-70 blur-xl"></div>
                    <img 
