...
<section id="experience" class="py-20">
    <div class="container mx-auto px-6">
        ...
        <div class="relative">
            ...
            <div class="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 h-full w-0.5 bg-neutral-200 dark:bg-neutral-700"></div>
            ...
            <div class="relative z-10 mb-16">
                ...
                >
                    <div class="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
                        <div class="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm inline-block">
                            ...
                            <p class="text-neutral-700 dark:text-neutral-300">
                                Accompagnement de startups et entreprises dans la définition et l'exécution de leur stratégie produit.
                            </p>
                            <div class="mt-4 flex flex-wrap gap-2">
                                ...
                                <span class="px-3 py-1 bg-secondary-100 dark:bg-secondary-900 text-secondary-800 dark:text-secondary-200 text-xs font-medium rounded-full">
                                    SaaS
                                </span>
                                <span class="px-3 py-1 bg-tertiary-100 dark:bg-tertiary-900 text-tertiary-800 dark:text-tertiary-200 text-xs font-medium rounded-full">
                                    E-commerce
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center justify-center w-10 h-10 rounded-full bg-primary-600 dark:bg-primary-500 text-white z-10 relative md:mx-auto">
            ...
            <div class="relative z-10 mb-16">
                ...
                >
                    ...
                    <div class="flex items-center justify-center w-10 h-10 rounded-full bg-secondary-600 dark:bg-secondary-500 text-white z-10 relative md:mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="md:w-1/2 md:pl-12 md:text-left">
                        <div class="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm inline-block">
                            ...
                            <p class="text-neutral-700 dark:text-neutral-300">
                                Direction de l'équipe produit pour la plateforme de trading et d'investissement. Croissance de l'utilisation de 300% en 2 ans.
                            </p>
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="px-3 py-1 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 text-xs font-medium rounded-full">
                                    Fintech
                ...
                >
                    <div class="md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
                        <div class="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm inline-block">
                            ...
                            <p class="text-neutral-700 dark:text-neutral-300">
                                Responsable des fonctionnalités de paiement et de transfert d'argent. Lancement de la carte premium et des comptes partagés.
                            </p>
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="px-3 py-1 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 text-xs font-medium rounded-full">
                                    Néobanque
                    ...
                    <div class="flex items-center justify-center w-10 h-10 rounded-full bg-tertiary-600 dark:bg-tertiary-500 text-white z-10 relative md:mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                    ...
                    <div class="md:w-1/2 md:pl-12 md:text-left">
                        <div class="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm inline-block">
                            ...
                            <p class="text-neutral-700 dark:text-neutral-300">
                                Développement des fonctionnalités de réservation et de paiement. Participation à l'expansion internationale en Europe.
                            </p>
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="px-3 py-1 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 text-xs font-medium rounded-full">
                                    Mobilité
